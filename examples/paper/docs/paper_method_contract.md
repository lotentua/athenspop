# CSuM2026 Paper Method Contract
...
- Diary origin clock: `t0 = 04:00`; diary second `0` is 04:00 and diary second `86400` is 04:00 on the following day.
...
- The migrated routing resource `examples/paper/data/travel_time/routing.npz` has SHA256 `AD0D374DDC65E9ADE0EDE53041534041D8305FE06FCFA839AF7815082DACC5DC`; `examples/paper/data/travel_time/zone_encoder.json` has SHA256 `AED03BAC02F1FD0D56CEE0A8CA4589AABEBFC08CF336A3F98D047E5656949873`.
...
- The output manifest in `docs/design/paper_output_manifest.md` lists the required public artifacts and their v1 acceptance rules.
