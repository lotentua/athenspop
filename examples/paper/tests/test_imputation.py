...
from examples.paper.imputation import (
    IMPUTATION_METHOD,
    impute_paper_return_home_trips,
)
from examples.paper.reproduce import _scheduled_trips_frame


def test_paper_return_home_imputation_uses_empirical_return_departures() -> None:
    ...
    imputed = impute_paper_return_home_trips(
        scheduled,
        travel_time_fn=_constant_travel_time,
        seed=2026,
