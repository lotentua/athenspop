"""Paper-specific return-home imputation for the CSuM2026 example workflow."""
...
def impute_paper_return_home_trips(
    ...
    *,
    ...
    for diary in scheduled.diaries:
        result = _maybe_impute_diary(diary, sampler=sampler, rng=rng, travel_time_fn=travel_time_fn)
    ...
    *,
    ...
    if last_trip.arrival_second is None:
        return _issue(
            ...
            "Paper return-home imputation requires a scheduled final reported trip.",
            last_trip,
        )
    ...
    try:
        travel_time_seconds = travel_time_fn(last_trip.destination, home_location, last_trip.mode, departure_second)
