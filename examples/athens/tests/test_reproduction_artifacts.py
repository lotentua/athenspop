...
def test_write_smoke_artifacts_materializes_named_athens_outputs(tmp_path: Path) -> None:
    ...
    artifact_validation = validate_athens_artifacts(paths, expectations=SMOKE_ARTIFACT_EXPECTATIONS)
