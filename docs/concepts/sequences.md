...
Activity episodes use the previous destination purpose by default. Travel episodes use a caller-provided labeler or a `trip_`-prefixed mode label, which prevents activity and travel vocabularies from colliding silently.
