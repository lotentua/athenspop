...
The [documentation](https://github.com/lotentua/athenspop/blob/main/docs/index.md) explains the data contract, scheduling constraints, sequence methods, clustering interpretation, and failure boundaries. Two executable, notebook-like workflows show how to compose the tools:

- [compose_schedule.py](https://github.com/lotentua/athenspop/blob/main/examples/compose_schedule.py) builds and analyzes a synthetic diary with a caller-supplied travel-time function.
- [analyze_athens.py](https://github.com/lotentua/athenspop/blob/main/examples/analyze_athens.py) performs an exploratory purpose-chain analysis of the released Athens respondent diaries.

The processed [Athens respondent travel diaries](https://github.com/lotentua/athenspop/blob/main/data/athens/README.md) are a separate data product licensed under CC BY 4.0 International. The software does not include a routing matrix or geographic zone crosswalk.
...
The project uses `uv`, Ruff, ty, pytest, coverage.py, Sphinx, and Hatch. See [CONTRIBUTING.md](https://github.com/lotentua/athenspop/blob/main/CONTRIBUTING.md) for the complete local checks.

Software is released under the [MIT License](https://github.com/lotentua/athenspop/blob/main/LICENSE). Theodore Chatziioannou holds the 2022 software copyright, and National Technical University of Athens holds the 2026 software copyright.
